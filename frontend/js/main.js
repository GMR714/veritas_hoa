...
const i18n = {
  en: {
    ...
    msg_sign: "Approve the request in your wallet (free, no gas)...",
    msg_check_nft: "Checking your membership pass...",
    msg_connected: "Connected! All actions are free.",
    msg_disconnect: "Disconnected.",
    err_connect: "Connect wallet first!",
    err_select_nft: "Select your membership pass!",
    ...
    msg_minting: "Issuing membership pass...",
    msg_mint_ok: "Membership pass issued! ✅",
    ...
    msg_guest_enter: "Welcome! You have a demo pass with 50 credits to try things out.",
    msg_guest_action: "This is a demo action — it won't be saved.",
    btn_upgrade: "Connect Wallet",
    guest_nft_label: "Demo Pass",
  ...
  es: {
    ...
    err_select_nft: "¡Selecciona tu pase de miembro!",
    ...
    msg_minting: "Emitiendo pase de miembro...",
    msg_mint_ok: "¡Pase de miembro emitido! ✅",
    ...
    msg_guest_enter: "¡Bienvenido! Tienes un pase de prueba con 50 créditos para probar.",
    msg_guest_action: "Esta es una acción de demostración — no se guardará.",
    btn_upgrade: "Conectar Billetera",
    guest_nft_label: "Pase de Prueba",
  ...
  document.querySelectorAll('[data-i18n]').forEach(el => {
    ...
    const staticDict = {
      en: {
        ...
        admin_panel: "Admin Panel", admin_mint_lbl: "Issue Member Pass", btn_mint: "Issue",
        ...
        my_nfts: "My Passes", tab_ideas: "Ideas", tab_proposals: "Proposals", tab_results: "Results",
        head_ideas: "Idea Basket", desc_ideas: "Suggest and vote on community ideas", new_idea: "New Idea",
        opt_select_nft: "Select your pass", btn_submit_idea: "Submit Idea", empty_connect: "Connect wallet to see ideas.",
      ...
      es: {
        ...
        admin_panel: "Panel Admin", admin_mint_lbl: "Emitir Pase de Miembro", btn_mint: "Emitir",
        ...
        my_nfts: "Mis Pases", tab_ideas: "Ideas", tab_proposals: "Propuestas", tab_results: "Resultados",
        head_ideas: "Cesta de Ideas", desc_ideas: "Sugiere y vota por ideas de la comunidad", new_idea: "Nueva Idea",
        opt_select_nft: "Selecciona tu pase", btn_submit_idea: "Enviar Idea", empty_connect: "Conecta la billetera para ver ideas.",
